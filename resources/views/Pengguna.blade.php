...
<meta charset="UTF-8">
    ...
    <title>Space Roastery | Pengguna</title>
...
<style>
    ...
    * {
    ...
    #lokasi{
        background-image: url("image/lokasi.jpg");
        height: 90vh;
        width: 100%;
        background-size: cover;
    }
...
<body>
    <div class="header">
        <ul class="navbar">
            ...
            <li><a href="" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><img src="./user.png" alt="">Pengguna</a>
                <ul class="dropdown-menu">
                    <li><a href="{{route('logout')}}" class="dropdown-item">Logout</a></li>
                </ul>
            </li>
            <li><a href="{{route('katalogpengguna')}}">Katalog</a></li>
        </ul>
        <img src="https://www.spaceroastery.com/img/logo.png" alt="" class="logo">
        <a href=""><img src="image/add.png" alt="" class="cart"></a>
    </div>
        ...
        <div class="card1">
            ...
            <div class="col">
                    <div class="card h-100">
                        <img src="image/honey.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Lintong Honey Lemon</h5>
                            <p class="card-text">starts from</p>
                            <p class="card-text">IDR 75.000</p>
                            <a href="{{route('katalogpengguna')}}" class="btn btn-primary">Read more</a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100">
                        <img src="image/tamarin.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Buku Flower Bomb</h5>
                            <p class="card-text">starts from</p>
                            <p class="card-text">IDR 75.000</p>
                            <a href="{{route('katalogpengguna')}}" class="btn btn-primary">Read more</a>
                        </div>
                ...
                <div class="col">
                    <div class="card h-100">
                        <img src="image/blueberry.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
