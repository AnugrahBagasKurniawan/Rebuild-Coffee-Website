...
<body>
    <div class="header">
        <ul class="navbar">
            ...
            <li><a href="" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Pegawai</a>
                <ul class="dropdown-menu">
                    <li><a href="{{route('logout')}}" class="dropdown-item">Logout</a></li>
                </ul>
            </li>
            <li><a href="" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Master</a>
                <ul class="dropdown-menu">
                    <li><a href="{{route('katalog')}}" class="dropdown-item">Katalog</a></li>
                    <li><a href="{{route('Pesanan')}}" class="dropdown-item">Pesanan</a></li>
                </ul>
            </li>
        </ul>
