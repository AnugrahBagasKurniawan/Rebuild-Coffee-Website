    ...
    <div class="container-lg">
        <div class="row">
            ...
            <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0">
                <div class="konten">
                    <h2>Registrasi</h2>
                    <form action="{{route('simpanregistrasipengguna')}}" method="POST" enctype="multipart/form-data" class="border border-light p-2 mb-2 bg-light bg-gradient">
                        {{ csrf_field() }}
                        <div class="mb-3">
                    ...
                    <span class="badge text-bg-light">Anda sudah punya akun?<a href="{{route('LoginPengguna')}}">Login</a></span>
                </div>
            </div>
        </div>
