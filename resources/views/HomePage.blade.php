...
<body>
    <div class="header">
        <ul class="navbar">
            ...
            <li><a href="" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><img src="./user.png" alt="">Login</a>
                <ul class="dropdown-menu">
                    <li><a href="{{route('LoginAdmin')}}" class="dropdown-item">Pegawai</a></li>
                    <li><a href="{{route('LoginPengguna')}}" class="dropdown-item">Pengguna</a></li>
                </ul>
            </li>
        </ul>
        <img src="https://www.spaceroastery.com/img/logo.png" alt="" class="logo">
        <a href="DataPesanan.php"><img src="image/add.png" alt="" class="cart"></a>
    </div>
